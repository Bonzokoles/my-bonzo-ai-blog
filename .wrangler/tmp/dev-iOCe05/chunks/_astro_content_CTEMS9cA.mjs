...
import { aq as objectType, ar as dateType, as as arrayType, at as stringType, i as AstroError, au as RenderUndefinedEntryError, c as createComponent, am as unescapeHTML, a as renderTemplate, av as UnknownContentCollectionError, k as escape, aw as renderUniqueStylesheet, ax as renderScriptElement, ay as createHeadAndContent, r as renderComponent } from './astro/server_CENSSoee.mjs';
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_B0nnn-SU.mjs';
import { b as VALID_INPUT_FORMATS } from './consts_E5vvd6_0.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CWHC-ibO.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Fkzq6Wdh.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_C8X5N6sp.mjs');
