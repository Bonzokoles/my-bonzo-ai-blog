...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Projekt 6 - MyBonzo AI Lab", "description": "Eksperymentalny projekt AI dla klienta" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container mx-auto px-4 py-16"> <a href="/eksperymenty" class="text-blue-600 dark:text-blue-400 hover:underline mb-6 inline-block">
← Powrót do Laboratorium
</a> <h1 class="text-4xl font-bold mb-4">🔬 Projekt 6</h1> <div class="prose dark:prose-invert max-w-none"> <h2>Opis projektu</h2> <p>
...
}, "U:/WWW_MYbonzoai_blog/src/pages/eksperymenty/projekt-6/index.astro", void 0);

const $$file = "U:/WWW_MYbonzoai_blog/src/pages/eksperymenty/projekt-6/index.astro";
const $$url = "/eksperymenty/projekt-6";
