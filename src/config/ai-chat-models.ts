export type ChatModelOption = {
  ...
  description: string;
  usageHint?: string;
  provider?: 'cloudflare' | 'openrouter'; // Provider type for routing
};
...
export const CHAT_MODELS: ChatModelOption[] = [
  ...
  // OpenRouter Models (OpenAI)
  {
    ...
    description:
      'Najnowszy multimodalny model OpenAI. Doskonala jakosc rozumowania, native polski, szybki i ekonomiczny.',
  ...
  },
  {
    ...
    description:
      'Lekka wersja GPT-4o. Bardzo szybki, tanszy, swietny do codziennych rozmow i Q&A.',
  ...
  },
  {
    ...
    description:
      'Model rozumowania OpenAI. Specjalizuje sie w matematyce, logice i analizie krok po kroku.',
  ...
  // OpenRouter Models (Anthropic)
  {
    ...
    description:
      'Flagship model Anthropic. Wyjatkowa jakosc pisania, analiza dokumentow, doskonaly polski.',
  ...
  },
  {
    ...
    description:
      'Najszybszy model Anthropic. Niski koszt, swietna responsywnosc, dobry balans jakosc/cena.',
  ...
  // OpenRouter Models (Google)
  {
    ...
    description:
      'Flagship model Google. Duzy kontekst (1M tokens), multimodalnosc, swietna analiza danych.',
