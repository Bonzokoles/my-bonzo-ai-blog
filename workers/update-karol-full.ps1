...
$jsonBody = $updatedPost | ConvertTo-Json -Depth 3
...
try {
    ...
    $response = Invoke-RestMethod -Uri "$workerUrl/api/blog/005" -Method PUT -Body $jsonBody -ContentType "application/json"
